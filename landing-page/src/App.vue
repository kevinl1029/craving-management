  ...
  <main class="landing-page">
    ...
    <section class="section content-section founder-section fade-in">
      <div class="container content-container">
        ...
        <p class="section-text">What finally worked was journaling. Writing through <em>my</em> triggers. <em>My</em> beliefs. The specific moments when I reached for it. Once I personalized it—made it about my life, not abstract theory—everything clicked. The wanting just stopped and so did my cravings.</p>
